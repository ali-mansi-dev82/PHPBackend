...
class Database
{
    ...
    {
        $this->db = new \PDO("mysql:host=localhost;dbname=h288104_software;charset=utf8;port=3306", "root", "");
    }
    public function query()
    {
        $sql = "INSERT INTO `sw_users` (`id`, `fullName`, `mobile`, `email`, `authMethod`, `password`, `otpCode`, `otpCodeExpires`, `verfiedAccount`, `accessToken`, `role`, `createdAt`, `updatedAt`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?);";
        $this->db->prepare($sql)->execute([NULL, 'علی منصوری', '+989919563244', NULL, 'otp', NULL, '365412', '0', '0', ' ', 'user', '2024-10-22 22:49:43.000000', '2024-10-30 22:49:43.000000']);
    }
} 
